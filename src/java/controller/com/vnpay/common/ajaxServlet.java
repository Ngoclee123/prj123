 ...
 */
package controller.com.vnpay.common;

import dal.orderDao.OrderDAO;  // Đảm bảo đúng tên class
...
public class ajaxServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp)
        ...
        if (req.getParameter("finalPrice2") == null) {
        ...
        double finalPrice2 = Double.parseDouble(req.getParameter("finalPrice2"));
        ...
        if (paymentMethod == null || shippingMethod == null || address == null || phone == null
            ...
            resp.sendRedirect(req.getContextPath() + "/cart/confirm_order.jsp");
            return;
        }
        System.out.println("finalprice 2" + finalPrice2);
...
//themmmmm
        ...
        long amount = (long) (finalPrice2*100);

...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Roboto', 'Segoe UI', sans-serif; }
        ...
        .sidebar { 
            width: 250px; 
            background: linear-gradient(135deg, #0f2b2b, #1e4b4b);
            padding: 20px; 
            color: white; 
            position: fixed; 
            height: 100vh; 
        ...
        .user-info-table { display: none; margin-top: 20px; border-collapse: separate; border-spacing: 0; width: 100%; background-color: #fff; box-shadow: 0 4px 15px rgba(0, 0, 0, 0.1); border-radius: 10px; overflow: hidden; }
        .user-info-table th, .user-info-table td { padding: 12px 20px; text-align: left; border-bottom: 1px solid #e0e0e0; }
        .user-info-table th { background-color: #3498db; color: white; font-weight: 600; text-transform: uppercase; font-size: 14px; }
        .user-info-table td { background-color: #f9f9f9; color: #333; font-size: 14px; }
        .user-info-table tr:last-child td { border-bottom: none; }
        .user-info-table tr:hover td { background-color: #f0f8ff; }
